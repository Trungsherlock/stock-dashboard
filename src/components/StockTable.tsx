            ...
            <table className="w-full border-collapse bg-white shadow-lg rounded-lg overflow-hidden">
                <thead className="bg-linear-to-r from-blue-600 to-blue-700">
                    <tr>
                        ...
                        >
                            Symbols <SortArrow field="symbol" sortField={sortField} sortDirection={sortDirection} />
                        </th>
                        <th
                        ...
                        >
                            Price <SortArrow field="price" sortField={sortField} sortDirection={sortDirection} />
                        </th>
                        <th
                            className="px-6 py-4 text-right text-sm font-semibold text-white uppercase tracker-wider cursor-pointer hover:bg-blue-800 transition-colors"
                            onClick={() => handleSort('change')}
                        >
                            Change (%) <SortArrow field="change" sortField={sortField} sortDirection={sortDirection} />
                        </th>
                        <th
                            className="px-6 py-4 text-right text-sm font-semibold text-white uppercase tracker-wider cursor-pointer hover:bg-blue-800 transition-colors"
                            onClick={() => handleSort('previousClose')}
                        >
                            Prev Close <SortArrow field="previousClose" sortField={sortField} sortDirection={sortDirection} />
                        </th>
                        <th
                            className="px-6 py-4 text-right text-sm font-semibold text-white uppercase tracker-wider cursor-pointer hover:bg-blue-800 transition-colors"
                            onClick={() => handleSort('open')}
                        >
                            Open <SortArrow field="open" sortField={sortField} sortDirection={sortDirection} />
                        </th>
                        <th
                            className="px-6 py-4 text-right text-sm font-semibold text-white uppercase tracker-wider cursor-pointer hover:bg-blue-800 transition-colors"
                            onClick={() => handleSort('high')}
                        >
                            High <SortArrow field="high" sortField={sortField} sortDirection={sortDirection} />
                        </th>
                        <th
                            className="px-6 py-4 text-right text-sm font-semibold text-white uppercase tracker-wider cursor-pointer hover:bg-blue-800 transition-colors"
                            onClick={() => handleSort('low')}
                        >
                            Low <SortArrow field="low" sortField={sortField} sortDirection={sortDirection} />
                        </th>
                    </tr>
                </thead>
